...
{
    public class ButtonACS : System.Windows.Forms.Button
    {
        Color clr1, clr2;
        ...
        private String text = "";
        private int arcRoundRectangle = 5;
        ...
        public int Arc
        {
            get { return arcRoundRectangle; }
            set { arcRoundRectangle = value; Invalidate(); }
        }
        ...
        void DrawRoundRectangularButton(Graphics g, int arc)
        {
            Color c1 = Color.FromArgb(color1Transparent, color1);
            Color c2 = Color.FromArgb(color2Transparent, color2);
            ...
            Region region = new System.Drawing.Region(new Rectangle(arc, arc, this.Width, this.Height));

            GraphicsPath grp = new GraphicsPath();
            /*
            grp.AddArc(5, 5, 40, 40, 180, 90);                                               // Ligne 
            grp.AddLine(25, 5, this.Width - 25, 5);                                          // Ligne 
            grp.AddArc(this.Width - 45, 5, 40, 40, 270, 90);                                 // Ligne 
            grp.AddLine(this.Width - 5, 25, this.Width - 5, this.Height - 25);               // Ligne 
            grp.AddArc(this.Width - 45, this.Height - 45, 40, 40, 0, 90);                    // Ligne 
            grp.AddLine(25, this.Height - 5, this.Width - 25, this.Height - 5);              // Ligne 
            grp.AddArc(5, this.Height - 45, 40, 40, 90, 90);                                 // Ligne 
            grp.AddLine(5, 25, 5, this.Height - 25);                                         // Ligne 
            */
            int largeur = arc * 8;
            int decal = largeur + arc;
            grp.AddArc(arc, arc, largeur, largeur, 180, 90);                                               // Ligne 
            grp.AddLine(25, arc, this.Width - 25, arc);                                          // Ligne 
            grp.AddArc(this.Width - decal, arc, largeur, largeur, 270, 90);                                 // Ligne 
            grp.AddLine(this.Width - arc, 25, this.Width - arc, this.Height - 25);               // Ligne 
            grp.AddArc(this.Width - decal, this.Height - decal, largeur, largeur, 0, 90);                    // Ligne 
            grp.AddLine(25, this.Height - arc, this.Width - 25, this.Height - arc);              // Ligne 
            grp.AddArc(arc, this.Height - decal, largeur, largeur, 90, 90);                                 // Ligne 
            grp.AddLine(arc, 25, arc, this.Height - 25);                                         // Ligne 
            ...
            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawArc(new Pen(buttonborder_1), arc + i, arc + i, largeur, largeur, 180, 90);
                g.DrawLine(new Pen(buttonborder_1), 25, arc + i, this.Width - 25, arc + i);
                g.DrawArc(new Pen(buttonborder_1), this.Width - decal - i, 5 + i, largeur, largeur, 270, 90);
                g.DrawLine(new Pen(buttonborder_1), arc + i, 25, arc + i, this.Height - 25);


                g.DrawLine(new Pen(buttonborder_2), this.Width - 5 - i, 25, this.Width - 5 - i, this.Height - 25);
                g.DrawArc(new Pen(buttonborder_2), this.Width -decal - i, this.Height - decal - i, largeur, largeur, 0, 90);
                g.DrawLine(new Pen(buttonborder_2), 25, this.Height - 5 - i, this.Width - 25, this.Height - 5 - i);
                g.DrawArc(new Pen(buttonborder_2), arc + i, this.Height - decal - i, largeur, 40, 90, 90);
            ...
            */
            for (int i = 0; i < borderWidth; i++)
            {
                g.DrawArc(new Pen(buttonborder_1), arc + i, arc + i, largeur, largeur, 180, 90);
                g.DrawLine(new Pen(buttonborder_1), 25, arc + i, this.Width - 25, arc + i);
                g.DrawArc(new Pen(buttonborder_1), this.Width - decal - i, arc + i, largeur, largeur, 270, 90);
                g.DrawLine(new Pen(buttonborder_1), arc + i, 25, arc + i, this.Height - 25);


                g.DrawLine(new Pen(buttonborder_2), this.Width - arc - i, 25, this.Width - arc - i, this.Height - 25);
                g.DrawArc(new Pen(buttonborder_2), this.Width -decal - i, this.Height - decal - i, largeur, largeur, 0, 90);
                g.DrawLine(new Pen(buttonborder_2), 25, this.Height - arc - i, this.Width - 25, this.Height - arc - i);
                g.DrawArc(new Pen(buttonborder_2), arc + i, this.Height - decal - i, largeur, largeur, 90, 90);
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (buttonShape)
            {
                ...
                case ButtonsShapes.RoundRect:
                    this.DrawRoundRectangularButton(e.Graphics, arcRoundRectangle);
                    break;
            }
        }
